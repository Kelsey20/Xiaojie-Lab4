let weather = {
        ...
        fetch(url)
            .then(async (res) => {
                ...
                if (res.status == 200) {
                    ...
                    alert("No special character!! Please enter valid city")
    ...
    futureWeather: function (data) {
        ...
        for (let i = 1; i < 8; i++) {
            ...
            document.querySelector(".min_temp" + i).innerText = "Lowest : " + min_c + "°C/" + min_f + "°F";
            document.querySelector(".max_temp" + i).innerText = "Highest : " + max_c + "°C/" + max_f + "°F";
